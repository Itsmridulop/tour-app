...
function Window({ children, name }: { children: ReactNode; name: string }) {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen bg-white/10 backdrop-blur-sm z-50 transition-all duration-500">
      <div ref={ref} className="fixed top-2/4 left-2/4 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 shadow-custom-lg rounded-lg">
